...
public class ProbeHashMap<K,V> extends AbstractHashMap<K,V> {
     ...
     * @return ratio of the number of items in the hash map to the
    ...
    public double getLoadFactor(){
        ...
        return (double)(size()*100)/ (double)capacity;
    }

    //lab8 step4 question

    /**
     *because in function bucketPut happen one time collisions it will be ++
     * @return collesions time directly
     */
    public int getCollisions(){
//        int collsion = 0;
//        ArrayList<Entry<K,V>> buffer = new ArrayList<>(n);
//        for (int i = 0; i < table.length; i++) {
//            if(isAvailable(i)) collsion++;
//        }
//        return collsion-size();
        return collsions;
        //int collsion = 0;
    }

    /**
     *automatically rebuilds itself when the number of DEFUNCT entries
     * reaches 25% of the hash map capacity
     * @return retable
     */
