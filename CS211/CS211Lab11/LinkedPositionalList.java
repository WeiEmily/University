...
public class LinkedPositionalList<E> implements PositionalList<E> {
	 ...
	 */
	private static class Node<E> implements CS211Lab11.Position<E> {
	 ...
	 */
	private Node<E> validate(CS211Lab11.Position<E> p) throws IllegalArgumentException {
	 ...
	 */
	private CS211Lab11.Position<E> position(Node<E> node) {
	 ...
	 */
	@Override
	public CS211Lab11.Position<E> first() {
	 ...
	 */
	@Override
	public CS211Lab11.Position<E> last() {
	 ...
	 */
	@Override
	public CS211Lab11.Position<E> before(CS211Lab11.Position<E> p) throws IllegalArgumentException {
	 ...
	 */
	@Override
	public CS211Lab11.Position<E> after(CS211Lab11.Position<E> p) throws IllegalArgumentException {
		Node<E> node = validate(p);
	 ...
	 */
	private CS211Lab11.Position<E> addBetween(E e, Node<E> pred, Node<E> succ) {
	 ...
	 */
	@Override
	public CS211Lab11.Position<E> addFirst(E e) {
	 ...
	 */
	@Override
	public CS211Lab11.Position<E> addLast(E e) {
	 ...
	 */
	@Override
	public CS211Lab11.Position<E> addBefore(CS211Lab11.Position<E> p, E e)
	 ...
	 */
	@Override
	public CS211Lab11.Position<E> addAfter(CS211Lab11.Position<E> p, E e)
			throws IllegalArgumentException {
		Node<E> node = validate(p);
	 ...
	 */
	@Override
	public E set(CS211Lab11.Position<E> p, E e) throws IllegalArgumentException {
		Node<E> node = validate(p);
	 ...
	 */
	@Override
	public E remove(CS211Lab11.Position<E> p) throws IllegalArgumentException {
		Node<E> node = validate(p);
	 ...
	 */
	private class PositionIterator implements Iterator<CS211Lab11.Position<E>> {

		/** A Position of the containing list, initialized to the first position. */
		private CS211Lab11.Position<E> cursor = first(); // position of the next element to report
		/** A Position of the most recent element reported (if any). */
		private CS211Lab11.Position<E> recent = null; // position of last reported element
		 ...
		 */
		public CS211Lab11.Position<E> next() {
			if (cursor == null)
				;
	...
	private class PositionIterable implements Iterable<CS211Lab11.Position<E>> {
		public Iterator<CS211Lab11.Position<E>> iterator() {
	 ...
	 */
	@Override
	public Iterable<CS211Lab11.Position<E>> positions() {
