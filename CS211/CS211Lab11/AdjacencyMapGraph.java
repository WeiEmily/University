...
public class AdjacencyMapGraph<V, E> implements Graph<V, E> {
    ...
    private PositionalList<CS211Lab11.Vertex<V>> vertices = new LinkedPositionalList<>();
    ...
    public Iterable<CS211Lab11.Vertex<V>> vertices() {
        return vertices;
    }
     ...
     */
    public int outDegree(CS211Lab11.Vertex<V> v) throws IllegalArgumentException {
     ...
     * @throws IllegalArgumentException if v is not a valid vertex
     */
    public Iterable<Edge<E>> outgoingEdges(CS211Lab11.Vertex<V> v) throws IllegalArgumentException {
        InnerVertex<V> vert = validate(v);
     ...
     * @throws IllegalArgumentException if v is not a valid vertex
     */
    public int inDegree(CS211Lab11.Vertex<V> v) throws IllegalArgumentException {
        InnerVertex<V> vert = validate(v);
     ...
     * @throws IllegalArgumentException if v is not a valid vertex
     */
    public Iterable<Edge<E>> incomingEdges(CS211Lab11.Vertex<V> v) throws IllegalArgumentException {
        InnerVertex<V> vert = validate(v);
        return vert.getIncoming().values(); // edges are the values in the adjacency map
    }

    /** Returns the edge from u to v, or null if they are not adjacent. */
    public Edge<E> getEdge(CS211Lab11.Vertex<V> u, CS211Lab11.Vertex<V> v) throws IllegalArgumentException {
     ...
     * order is arbitrary.
     */
    public CS211Lab11.Vertex<V>[] endVertices(Edge<E> e) throws IllegalArgumentException {
        InnerEdge<E> edge = validate(e);
        return edge.getEndpoints();
    }

    /** Returns the vertex that is opposite vertex v on edge e. */
    public CS211Lab11.Vertex<V> opposite(CS211Lab11.Vertex<V> v, Edge<E> e)
            throws IllegalArgumentException {
        InnerEdge<E> edge = validate(e);
        CS211Lab11.Vertex<V>[] endpoints = edge.getEndpoints();
        if (endpoints[0] == v)
            return endpoints[1];
    ...
    public CS211Lab11.Vertex<V> insertVertex(V element) {
     ...
     */
    public Edge<E> insertEdge(CS211Lab11.Vertex<V> u, CS211Lab11.Vertex<V> v, E element)
            throws IllegalArgumentException {
        if (getEdge(u, v) == null) {
    ...
    public void removeVertex(CS211Lab11.Vertex<V> v) throws IllegalArgumentException {
        InnerVertex<V> vert = validate(v);
    ...
    @SuppressWarnings({ "unchecked" })
    private InnerVertex<V> validate(CS211Lab11.Vertex<V> v) {
    ...
    private class InnerVertex<V> implements CS211Lab11.Vertex<V> {
        private V element;
        private CS211Lab11.Position<CS211Lab11.Vertex<V>> pos;
        private Map<CS211Lab11.Vertex<V>, Edge<E>> outgoing, incoming;
        ...
        public void setPosition(CS211Lab11.Position<CS211Lab11.Vertex<V>> p) {
            pos = p;
        }

        /** Returns the position of this vertex within the graph's vertex list. */
        public CS211Lab11.Position<CS211Lab11.Vertex<V>> getPosition() {
            return pos;
        }

        /** Returns reference to the underlying map of outgoing edges. */
        public Map<CS211Lab11.Vertex<V>, Edge<E>> getOutgoing() {
            return outgoing;
        }
    ...
    private class InnerEdge<E> implements Edge<E> {
        private E element;
        private CS211Lab11.Position<Edge<E>> pos;
        private CS211Lab11.Vertex<V>[] endpoints;

        @SuppressWarnings({ "unchecked" })
        /** Constructs InnerEdge instance from u to v, storing the given element. */
        public InnerEdge(CS211Lab11.Vertex<V> u, CS211Lab11.Vertex<V> v, E elem) {
            element = elem;
            endpoints = (CS211Lab11.Vertex<V>[]) new CS211Lab11.Vertex[] { u, v }; // array of length 2
        }
        ...
        public CS211Lab11.Vertex<V>[] getEndpoints() {
            return endpoints;
        }
        ...
        public void setPosition(CS211Lab11.Position<Edge<E>> p) {
            pos = p;
        }
